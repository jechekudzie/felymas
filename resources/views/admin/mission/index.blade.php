                ...
                <div class="card">
                    ...
                    <ul class="nav nav-tabs customtab" role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span
                                        ...
                                        class="hidden-xs-down">Vision and Mission</span></a></li>
                    </ul>
                    <br/>
                    @if (session('message'))
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <!-- Card -->
                                                        <div class="card">
                                                            <img class="card-img-top img-responsive" src="{{asset($aboutus->path)}}"
                                                                 alt="Card image cap">
                                                        </div>
                                                        <!-- Card -->
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 img-responsive">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <a href="/admin/about/{{$aboutus->id}}/edit" class="btn btn-primary">Edit
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <!-- Card -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="/admin/vision" class="btn btn-success"><i
