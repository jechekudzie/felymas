    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/services" class="btn btn-success"></i> BACK</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="/admin/services/{{$service->id}}" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="description" id="editor" class="form-control" required
                                                      data-validation-required-message="This field is required">{{$service->description}}</textarea>
                                        </div>
                                        <div class="form-control-feedback">
                                        </div>
                                    </div>
                            ...
                            <div class="col-3 col-md-3">
                                <div class="card">
                                    ...
                                    <img class="card-img-top img-responsive" src="{{asset($service->path)}}" alt="Card image cap">
                                    <div class="card-body">
                                        {{--
                                ...
                                <form action="/admin/services/image_cover/{{$service->id}}" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
