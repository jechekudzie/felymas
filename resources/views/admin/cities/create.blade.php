                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">Create New City/Location</h4>
                                {{--
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/about" method="post" class="m-t-40" novalidate>
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <h5>Provinces <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <select name="province_id" id="select" required class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <div class="form-group">
                                        <h5> City/Location <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <div class="controls">
                                            <input type="submit" name="add_profession"
                                                   ...
                                                   value="Create New City/Location">
                                        </div>
