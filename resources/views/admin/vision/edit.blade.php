            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="/admin/vision/{{$vision->id}}" method="post" enctype="multipart/form-data" class="m-t-40" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="description" id="editor" class="form-control" required
                                                      data-validation-required-message="This field is required">{{$vision->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="controls">
                            ...
                            <div class="col-6">
                                <form action="/admin/vision/image_cover/{{$vision->id}}" method="post" enctype="multipart/form-data" class="m-t-40" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    <div class="form-group">
