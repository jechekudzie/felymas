    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/team" class="btn btn-success"></i> BACK</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="/admin/team/{{$team->id}}" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <h5> Member qualification <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="qualification" value="{{$team->qualification}}" class="form-control"
                                                   required
                                                   data-validation-required-message="This field is required">
                                        </div>
                                        <div class="form-control-feedback">
                                    ...
                                    <div class="form-group">
                                        <h5> Member Description <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <textarea name="description" id="editor" class="form-control" required
                                                      data-validation-required-message="This field is required">{{$team->description}}</textarea>
                                        </div>
                                        <div class="form-control-feedback">
                                        </div>
                                    </div>
                            ...
                            <div class="col-3 col-md-3">
                                <div class="card">
                                    <h3>Current prrofile picture</h3>
                                    <img class="card-img-top img-responsive" src="{{asset($team->path)}}" alt="Card image cap">
                                    <div class="card-body">
                                        {{--
                                ...
                                <form action="/admin/team/image_cover/{{$team->id}}" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
