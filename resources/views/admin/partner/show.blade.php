    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <a href="/admin/partners" class="btn btn-success"></a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <h6 class="card-subtitle">Delete {{$partner->name}} </h6>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/partners/{{$partner->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want to delete {{$partner->name}} ?</span></h5>
