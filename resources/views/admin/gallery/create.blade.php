    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <a href="/admin/gallery" class="btn btn-success"></i> BACK</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/gallery" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{csrf_field()}}

                                    <div class="form-group">
                                        <h5> Image Caption <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="file" name="file[]" multiple value="{{old('file')}}" class="form-control"
                                                   required
                                                   data-validation-required-message="This field is required">
                                        </div>
                                        <div class="form-control-feedback">
