    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <a href="/admin/gallery" class="btn btn-success">Back</a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">{{$gallery->caption}} </h4>
                                <h6 class="card-subtitle">Delete {{$gallery->caption}} </h6>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-7">
                                <form action="/admin/gallery/{{$gallery->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                            ...
                            <div class="col-3 col-md-3">
                                <!-- Card -->
                                <div class="card">
                                    <img class="card-img-top img-responsive" src="{{asset($gallery->path)}}" alt="Card image cap">
                                    <div class="card-body">
                                        {{--
