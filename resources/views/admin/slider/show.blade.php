    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <a href="/admin/sliders" class="btn btn-success"></a>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <h6 class="card-subtitle">Delete {{$slider->caption}} </h6>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-7">
                                <form action="/admin/sliders/{{$slider->id}}" method="post" class="m-t-40" novalidate>
                                    {{method_field('DELETE')}}
                                    {{csrf_field()}}
                                        <h5><span class="text-danger">Are you sure you want delete slider with caption {{$slider->caption}} ?</span></h5>
