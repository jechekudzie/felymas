$(function () {
    ...
    function o(e) {
        ...
        }), $("body").addClass(e), i = "skin", s = e, "undefined" != typeof Storage ? localStorage.setItem(i, s) : window.alert("Please use a modern browser to properly view this template!"), !1
    }

    (s = function (e) {
        if ("undefined" != typeof Storage) return localStorage.getItem(e);
        window.alert("Please use a modern browser to properly view this template!")
    }("skin")) && $.inArray(s, a) && o(s), $("[data-skin]").on("click", function (e) {
