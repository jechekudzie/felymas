...
a.blocksAreSorted&&a.sortBlocks(a.blocks,"source.html"),a.isAnimating=!1,a.$obj.trigger("filterComplete.cbp"),a.triggerEvent("filterFinish")},computeBlocks:function(a){var b=this;
...
// if blocks are sorted (the index ascending is broken) revert
// this state so the index is ascending again
c.blocksAreSorted&&c.sortBlocks(c.blocks,"source.html")},/**
...
// order asc by index
return d.widthAndGap<e.widthAndGap?1:d.widthAndGap>e.widthAndGap?-1:d.heightAndGap<e.heightAndGap?1:d.heightAndGap>e.heightAndGap?-1:d.source>e.source?1:d.source<e.source?-1:void 0}),
...
// check singlePageInline and close it
if(e=e||!1,j.fromOpen=e,j.storeBlocks=c,j.storeCurrentBlock=d,j.isOpen)return g=a(d).closest(".cbp-item").source(),void(j.dataArray[j.current].url!==d.getAttribute("href")||j.current!==g?j.cubeportfolio.singlePageInline.close("open",{blocks:c,currentBlock:d,fromOpen:!0}):j.close());if(
// remember that the lightbox is open now
j.isOpen=!0,
// remember to stop all events after the popup has been showing
j.stopEvents=!1,
